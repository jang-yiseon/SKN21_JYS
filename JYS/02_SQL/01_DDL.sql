# 주석 (#, -- 둘 다 쓸 때 공백을 준 후 내용을 입력해야 함)
-- 한줄 주석 (--공백 으로 시작)
/* block 주석(코드 사이에 주석입력도 가능) */
...
**********************************************************************************************************/
-- local 접속 계정
create user 'ysjang'@'localhost' identified by '1111';
## 파이썬이랑 연결되는 계정
...
grant all privileges on *.* to 'ysjang'@'localhost';

grant all privileges on *.* to 'ysjang'@'%';

-- user 권한 조회
show grants for 'ysjang'@'%';
show grants for 'ysjang'@'localhost';
